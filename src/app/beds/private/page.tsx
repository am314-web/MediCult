  ...
  return (
    <>
      ...
      <div className="flex">
        ...
        <div className={`transition-all duration-300 ease-in-out bg-black h-full ${isDropdownOpen ? 'w-64' : 'w-16'}`}>
          <button
...
export default PrivateBedsPage;
